...
public class Constants {
    ...
    public static final String SQL_INSERT_INTO_DEPARTMENT = "INSERT INTO department VALUES (,?)";
    ...
    public static final String SQL_INSERT_INTO_EMPLOYEE = "INSERT INTO employee VALUES (,?,?,?,?,?)";
